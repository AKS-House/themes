  ...
  <?php endif;?>
    ...
    <form name="resetpassform" id="resetpassform" action="<?php echo esc_url(site_url($reset_pwd_url )); ?>" method="post" autocomplete="off">
      ...
      <input type="password" name="pass1" id="pass1" class="input" size="20" value="" autocomplete="off" 
             placeholder="<?php esc_attr_e('New password','profilegrid-user-profiles-groups-and-communities');?>" required="required" />
      
      <input type="password" name="pass2" id="pass2" class="input" size="20" value="" autocomplete="off" 
             placeholder="<?php esc_attr_e('Repeat new password','profilegrid-user-profiles-groups-and-communities');?>" required="required" />
